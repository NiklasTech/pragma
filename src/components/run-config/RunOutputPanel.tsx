...
import { useRunConfigStore, type RunStatus } from "@/stores/runConfig";
      ...
      <div className="flex items-center justify-between border-b border-border px-3 py-1.5">
        <div className="flex items-center gap-2">
          ...
          {activeProcess.exitCode !== null && (
            <span className="text-[10px] text-muted-foreground">exit {activeProcess.exitCode}</span>
          )}
        </div>
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="flex h-5 items-center gap-1 rounded px-1.5 text-[10px] text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
