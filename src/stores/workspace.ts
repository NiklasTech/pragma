...
export async function saveWorkspace(
  ...
  const data: WorkspaceData = {
    ...
    layout: {
      ...
      chatPanelOpen: layout.aiPanelOpen,
      chatPanelWidth: layout.aiPanelWidth,
...
export async function loadWorkspace(
  ...
  try {
    ...
    layout.setSidebarTab(data.layout.sidebarTab as "explorer" | "search" | "git" | "git-status");
    layout.setAIPanelOpen(data.layout.chatPanelOpen);
    layout.setAIPanelWidth(data.layout.chatPanelWidth);
    layout.setTerminalHeight(data.layout.terminalHeight);
    layout.setEditorHeight(data.layout.editorHeight);
