  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:outline-1"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Thumb
        ...
        className="relative flex-1 rounded-full bg-border/70 hover:bg-border"
      />
    </ScrollAreaPrimitive.Scrollbar>
  );
}
