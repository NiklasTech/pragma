  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-3 rounded-lg bg-popover p-3 text-ui-base text-popover-foreground ring-1 ring-border/60 shadow-xl duration-100 outline-none sm:max-w-sm data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className,
        )}
        {...props}
      >
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-3 -mb-3 flex flex-col-reverse gap-2 rounded-b-lg border-t border-border/40 bg-muted/30 p-3 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
